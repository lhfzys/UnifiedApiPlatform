...
/// 获取用户列表端点
/// </summary>
public class GetUsersEndpoint : QueryEndpointBase<GetUsersRequest, GetUsersQuery, PagedResult<UserDto>>
{
    public GetUsersEndpoint(IMediator mediator) : base(mediator)
    {
    }
    ...
    public override void Configure()
    {
        ...
        {
            Permissions = new[] { Shared.Constants.Policies.UsersView }, RequireAll = false
        }));
        Summary(s =>
        {
            s.Summary = "获取用户列表";
